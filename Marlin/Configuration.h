...
#define STRING_CONFIG_H_AUTHOR "@xadow, @brandstaetter, @grbd" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AKLP"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 421.32}  // 1/64 1685.28 1/16 steps 421.32
